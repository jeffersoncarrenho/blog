        ...
        <table class="table">
          <tr>
            ...
            <tr>
              ...
              <td>
                @if(Auth::user()->level >= 2)
                  <a onclick="editarArquivo('{{$arquivo->id}}', '{{$arquivo->name}}')" class="btn btn-sm btn-warning">Editar</a>
...
function editarArquivo($id, $name) {
  $('#id').val($id);
  $('#name').val($name);
...
<div class="modal fade" id="editarArquivo" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
